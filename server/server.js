...
/* =========================================================
   OPTIONAL: CHECK MAYA PAYMENT STATUS
========================================================= */

/*
    This endpoint can be useful for debugging/testing.

    It retrieves the payment directly from Maya using the
    SECRET KEY.

    Do NOT expose your secret key to the frontend.
*/
